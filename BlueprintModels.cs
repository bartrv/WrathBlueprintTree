...
public class BlueprintModels{
    ...
    public static void GenerateBpDictionary()
    {
        ...
        _modelDictionary.Add("BlueprintProgression", new OrderedDictionary {
                    ...
                    {"m_AllowNonContextActions", new List<string> {"Checkbox","user","visible","bool","false"}},
                    ...
                    {"HideInUI", new List<string> {"CheckBox","user","visible","bool","false"}},
                    {"HideInCharacterSheetAndLevelUp", new List<string> {"CheckBox","user","visible","bool","true","false"}},
                    {"HideNotAvailibleInUI", new List<string> {"CheckBox","user","visible","bool","false"}},
                    ...
                    {"ReapplyOnLevelUp", new List<string> {"CheckBox","user","visible","bool","false"}},
                    {"IsClassFeature", new List<string> {"CheckBox","user","visible","bool","false"}},
                    ...
                    {"ForAllOtherClasses", new List<string> {"CheckBox","user","visible","bool","false"}},
                    ...
                    {"GiveFeaturesForPreviousLevels", new List<string> {"CheckBox","user","visible","bool","true"}},
